...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(data.message, { position: "top-right", style: { margin: "45px" } });
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col justify-center py-5 sm:px-5 lg:px-5">
          ...
          <div className="space-y-3">
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 transition duration-200"
              >
                Sign in
              </button>
            ...
            <div className="mt-3 grid grid-cols-1 gap-3">
              <button
                ...
                onClick={() => window.open(`${backendURL}/api/users/google`, "_self")}
              >
                <img
                  className="h-4 w-4"
