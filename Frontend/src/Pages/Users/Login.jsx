...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e3ebef] flex flex-col justify-center py-12 sm:px-5 lg:px-8">
        ...
        <div className="bg-white py-8 px-4 shadow-sm rounded-lg sm:px-10 border border-gray-200">
          <div className="space-y-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              <button
                type="button"
                className="w-full inline-flex hover:cursor-pointer justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition duration-200"
              >
